...
export default function HelpCommands() {
    ...
    message.push('![commands](https://github.com/mattermost/docs/blob/master/source/images/slashCommandsTable1.png)');
    message.push('![commands](https://github.com/mattermost/docs/blob/master/source/images/slashCommandsTable2.png)');
